...
//global defines
#define CCPxCON			CCP4CON				//compare control register
#define CCPRxH			CCPR4H				//compare match register, msb
#define CCPRxL			CCPR4L				//compare match register, lsb
