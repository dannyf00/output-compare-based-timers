...
//global defines
#define CCPxCON			CCP2CON				//compare control register
#define CCPRxH			CCPR2H				//compare match register, msb
#define CCPRxL			CCPR2L				//compare match register, lsb
