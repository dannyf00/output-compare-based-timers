...
//global defines
#define CCPxCON			CCP5CON				//compare control register
#define CCPRxH			CCPR5H				//compare match register, msb
#define CCPRxL			CCPR5L				//compare match register, lsb
